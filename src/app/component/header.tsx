...
export default function Header (){
    return(
        <header className="bg-gradient-to-r from-sky-700 via-cyan-500 to-sky-600 text-gray-950 max-w-screen-2xl mx-auto">
            <div className="flex justify-between md:pt-6 md:pb-3 md:px-32 px-12 py-4 ">
                <h2 className="text-4xl font-bold">Prtfolio.</h2>
                <nav>
                    <ul className="hidden md:block">
                        <li className="flex gap-8 text-lg font-semibold pt-1 ">
                    ...
                    <Sheet>
                        <SheetTrigger className="md:hidden text-3xl bg-sky-600 mt-2"><IoMdMenu /></SheetTrigger>
                        <SheetContent>
                        <ul>
