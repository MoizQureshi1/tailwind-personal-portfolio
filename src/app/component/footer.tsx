...
export default function Footer (){
    return(
        <footer className="bg-gradient-to-r from-cyan-200 via-sky-200 to-cyan-200 text-gray-950 max-w-screen-2xl mx-auto">
            <div className="pt-12 pb-6 px-20 lg:flex lg:justify-around">
                <div>
            ...
            <hr />
            <div className="flex gap-5 pt-4 text-2xl pl-36 lg:pl-40">
            ...
            <p className="lg:pl-96 ml-32 pb-10 pt-5 text-md text-gray-600 font-semibold ">Copyright &copy; 2024 Adventour.</p>
        </footer>
    )
}