  ...
  return(
    <main className="bg-cover bg-center max-w-screen-2xl mx-auto" style={{ backgroundImage: "url('/background.png')" }}>
      <div className="lg:pl-20 lg:pr-36 lg:flex lg:pt-40 text-center sm:text-start pt-10 px-10 pb-32">
          <Image src={moiz} alt="moizimage" width={230} height={100} className="border-4 border-blue-800 mx-14 sm:mx-0 rounded-full mr-4 lg:ml-10"/>
        <div className="lg:pl-14">
          ...
          <div className="lg:mt-12 mt-5 ">
            <a href="https://www.linkedin.com/in/moiz-qureshi-0884592b9/" target="blank"><button className="border-2 border-teal-500 transition duration-300 ease-in-out bg-sky-500 hover:bg-teal-400 p-2 pl-10 pr-10 text-lg font-semibold mr-2 rounded-md text-teal-900 hover:text-sky-500">Hire Me</button></a>
